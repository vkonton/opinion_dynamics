...
that for every instance $I=(P,s,\alpha)$, each agent $i$ updates
...
an instance $I$ such that $x(t)$ converges to $x^*$ slowly.
...
\begin{lemma}\label{l:reduction}
  Let $A$ be an opinion dependent update rule such that for all instances $I=(P,s,a)$,
