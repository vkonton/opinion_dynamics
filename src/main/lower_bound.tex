...
an instance $I$ such that $x(t)$ converge to $x^*$ slowly.
...
can be used as an estimator of the parameter $p \in [0,1] $ of Bernoulli random
variable.
...
\begin{lemma}\label{l:reduction}
  Let $A$ an opinion dependent update rule such that for all instances $I=(P,s,a)$,
