...
As already mentioned FJ-model is one of the most influential models in opinion
...
To model the fact that in large networks, agents meet a small random subset of
