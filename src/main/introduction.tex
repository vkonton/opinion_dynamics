...
%that socially connected people (e.g. family, friends, colleagues)
%exchange information and this leads to changes in their expressed opinions
%over time. The wide use Internet and social media has extremely facilitated
%this information exchange and intensified the interest towards understanding
%the way opinions are formed  This understanding is of great importance in 
%todays's social and economic life since for various reasons 
%such as prediction, advertisement etc. To capture opinion formation on a formal level, 
%several have been proposed over the years (see e.g., \cite{DeGroot,FJ90,HK}.
%The very common assumption that all these models share and dates back to DeGroot
%\cite{DeGroot}, is that opinions evolve through a form of repeated averaging of 
%information collected from the agent's social neighborhoods.
...
are needed. We overcome the main technical difficulty, which lies in the stochastic nature of our
process, by using elegant concentration arguments.  In
...
It has little to do with the \enquote{large} information exchange that it requires and
...
No-regret dynamics in imperfect information settings have recently received substantial attention
