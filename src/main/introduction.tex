...
total disagreement cost that she experienced until $t-1$.  It also has a very
...
However, we present a short and simple proof that may be of interest.  Our
...
implies the existence of Bernoulli estimators with small sample complexity rate
...
our limited information exchange setting.  In Section~\ref{s:cc_convergence},
