\section{\emph{Follow the Leader} ensures no regret}\label{s:fictitious_noregret}
In this section we explain why update rule~(\ref{eq:fictitious_play}) 
(\enquote{Follow the Leader}) ensures
no regret to any agent that repeqtedly play the
...
Returning to the dynamics of the game in Definition~\ref{d:random_game}, it is reasonalbe to
