\section{FTL dynamics ensures no regret}\label{s:fictitious_noregret}
...
Returning in our repeated game, it is natural to
...
\change{We now present the key steps for proving Theorem~\ref{t:fictitious_noregret}}.
