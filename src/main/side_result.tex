...
In this section we provide an update rules showing that information about the
...
of the chosen neighbor, since the reduction involves only two neighbors
with different opinions and therefore, they are distinguishable.
