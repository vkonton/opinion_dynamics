...
Then with probability at least $1-\delta$, for all $t\geq B$ and for all
$i, j \in N_i$\[t-B\leq \pi_{ij}(t)\leq t.\]
%If the size of
%each epoch is
%\[
%B = \frac{2}{\min_{ij}p_{ij}}\ln \frac{nt}{\delta}
%\]
%then with probability at least $1-\delta$ all agents pick all their neighbours
