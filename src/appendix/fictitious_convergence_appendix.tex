\section{Convergence Rate of FTL Dynamics}\label{app:s:fictitious_convergence}
We present the proofs of Lemma~\ref{l:recursion_upper_bound}
and Theorem~\ref{t:fictitious_convergence} of
Section~\ref{s:fictitious_convergence}
